...
<html lang="en">
  <head>
    ...
    <title>Donovan's Photography Portfolio</title>
  </head>
...
<main role="main">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><img width="100%" height="100%" src="images/IMG_0348-2.jpg"/></svg>
        <div class="container">
          <div class="carousel-caption text-left">
            <h1>Check out my Nature Shots</h1>
            <p>I love the outdoors! They offer infinite opertunities to capture!</p>
      ...
      <div class="carousel-item">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><img width="100%" height="100%" src="images/IMG_5239-2.jpg"/></svg>
        <div class="container">
  ...
  <footer class="container">
    ...
    <p>&copy; 2019-2020 Donovan Montoya &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
  </footer>
</main>
