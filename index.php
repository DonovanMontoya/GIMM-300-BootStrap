    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
		  ...
		  <li class="nav-item">
          <a class="nav-link" href="http://3.84.54.106/index.php/contact/" target="_blank" tabindex="-1" aria-disabled="true">Contact Me [external link]</a>
        </li>
      </ul>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><img width="100%" height="100%" src="images/IMG_4367.jpg"/></svg>
        <div class="container">
          <div class="carousel-caption text-left">
            <h1>Check out my City Gallary</h1>
            <p>I love capturing the urban lifestyle!</p>
            <p><a class="btn btn-lg btn-primary" href="/bootstrap/pages/city-pictures.html" role="button">View</a></p>
          </div>
        </div>
      </div>
